...
export default function BentoGrid({ children }: { children: ReactNode }) {
  ...
  return (
    <>
      <motion.div
        className="mx-auto grid max-w-7xl grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-4 md:grid-cols-3 md:gap-4 lg:grid-cols-4 auto-rows-auto md:auto-rows-[minmax(180px,auto)]"
      >
        {enhancedChildren}
      </motion.div>
